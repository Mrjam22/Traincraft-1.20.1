...
public class TCItems {
    ...
    public static final RegistrySupplier<Item> item_normaltrack = ITEMS.register("normal_track", () -> new BlockItem(TCBlocks.normal_track.get(), new Item.Properties().arch$tab(Traincraft.TraincraftTab)));
